"""
Django settings for misty_cake_42889 project.
...
ROOT_URLCONF = 'misty_cake_42889.urls'
...
WSGI_APPLICATION = 'misty_cake_42889.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_cake_42889 API",
    "DESCRIPTION": "API documentation for misty_cake_42889 App",
    "VERSION": "v1",
}
